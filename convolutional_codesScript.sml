...
Proof
  ...
  >- (rpt strip_tac 
      >- (gvs[path_is_valid_def]
          ...
          >> gvs[vd_encode_state_helper_snoc])
      >- gvs[]
      >> gvs[path_is_valid_def]
      >> gvs[code_to_path_def]
  ...
  >- gvs[]
  >> rpt strip_tac
  >> Cases_on ‘ps’ using SNOC_CASES >> gvs[code_to_path_def, path_is_connected_def]
  ...
  >> gvs[]
  >> AP_TERM_TAC
  >> qspecl_then [‘m’, ‘bs’, ‘0’] assume_tac code_to_path_helper_last
  >> gvs[]       
QED
