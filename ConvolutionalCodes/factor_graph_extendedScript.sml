...
(* -------------------------------------------------------------------------- *)
(* These factor graphs have been extended to allow the variables to take      *)
(* values in an arbitrary length of bool list, rather than only individual    *)
(* bools.                                                                     *)
(* -------------------------------------------------------------------------- *)
...
(*                                                                            *)
(* A variable can take an n-bit value, represented as a bool list (in order   *)
(*   to allow for a TODO                                                      *)
(* -------------------------------------------------------------------------- *)
...
(* function node may be 1 words, whereas others may be 3 words, for example.  *)
(* -------------------------------------------------------------------------- *)
Datatype:
  factor_graph_rep = 
  <|
