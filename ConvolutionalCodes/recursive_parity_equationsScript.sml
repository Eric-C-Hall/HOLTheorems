...
(* -------------------------------------------------------------------------- *)
(* The length of a recursive parity equation with systematic bits             *)
(* -------------------------------------------------------------------------- *)
Theorem encode_recursive_parity_equation_with_systematic_length[simp]:
  ∀ps qs ts bs.
    LENGTH (encode_recursive_parity_equation_with_systematic (ps, qs) ts bs)
    = 2 * LENGTH bs
Proof
  rw[]
...
(* -------------------------------------------------------------------------- *)
(* The length of the state sequence generated by a recursive parity equation  *)
(* -------------------------------------------------------------------------- *)
Theorem encode_recursive_parity_equation_state_sequence_length[simp]:
  ∀ps qs ts bs.
    LENGTH (encode_recursive_parity_equation_state_sequence (ps,qs) ts bs) =
    LENGTH bs + 1
Proof
  Induct_on ‘bs’ >> rw[]
