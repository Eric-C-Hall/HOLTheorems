...
(* measure spaces.                                                            *)
(*                                                                            *)
(* We assume that all functions are defined up to the same value n, and       *)
(* beyond this point, all elements are set to ARB. This is because it isn't   *)
(* possible to tell the difference between, for example:                      *)
...
(* applciation, we want to always choose the same length n.                   *)
(*                                                                            *)
